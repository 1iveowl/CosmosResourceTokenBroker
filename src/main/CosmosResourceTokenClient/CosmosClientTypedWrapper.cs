...
//    internal class CosmosClientTypedWrapper<T>: IAsyncDisposable
//    {
...
//        internal CosmosClientTypedWrapper(
...
//            var cosmosCustomSerializer = new CosmosJsonNetSerializer(customJsonSerializer);

//            try
//            {
//                _cosmosClient = new CosmosClientBuilder(resourcePermissionResponse?.EndpointUrl, currentPermission?.ResourceToken)
//                    .WithCustomSerializer(cosmosCustomSerializer)
//                    .Build();
...
//            catch (Exception ex)
//            {
//                Debug.WriteLine($"Unable to instantiate {nameof(CosmosClientTypedWrapper<T>)}. Unhandled exception {ex}");
//                throw new CosmosClientException($"Unable to instantiate {nameof(CosmosClientTypedWrapper<T>)}. Unhandled exception {ex}", ex);
//            }
//        }
...
//                throw new CosmosClientException($"Unable to create: {typeof(T).FullName} with id: {id}. Status Code: {itemResponse.StatusCode.ToString()}");
...
//                throw new CosmosClientException($"Unable to create: {typeof(T).FullName}. Status Code: {ex.StatusCode}. Unhandled exception: {ex}", ex);
//            }
//            catch (Exception ex)
//            {
//                throw new CosmosClientException($"Unable to create: {typeof(T).FullName}. Unhandled exception: {ex}", ex);
//            }
//        }
...
//            catch (CosmosException ex)
//            {
//                throw new CosmosClientException($"Unable to read partition: {_partitionKeyStr}. Status Code: {ex.StatusCode}.", ex);
//            }
//            catch (Exception ex)
//            {
